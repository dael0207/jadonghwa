...
class ImplementationReadinessStatus(StrEnum):
...
class AuditAction(StrEnum):
    ...
    EVIDENCE_FILE_CONFIRMED = "EVIDENCE_FILE_CONFIRMED"
    IMPLEMENTATION_REQUIREMENTS_RECORDED = "IMPLEMENTATION_REQUIREMENTS_RECORDED"
    IMPLEMENTATION_PACKAGE_CREATED = "IMPLEMENTATION_PACKAGE_CREATED"
    IMPLEMENTATION_PACKAGE_VALIDATED = "IMPLEMENTATION_PACKAGE_VALIDATED"
    CODEGEN_READINESS_EVALUATED = "CODEGEN_READINESS_EVALUATED"
    IMPLEMENTATION_PACKAGE_EXPORTED = "IMPLEMENTATION_PACKAGE_EXPORTED"
